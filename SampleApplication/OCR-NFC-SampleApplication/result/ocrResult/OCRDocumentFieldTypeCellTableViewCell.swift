...
class OCRDocumentFieldTypeCellTableViewCell: UITableViewCell {

    @IBOutlet weak var fieldTypeNameLabel: UILabel!
    @IBOutlet weak var barcodeOrMrzLabel: UILabel!
    @IBOutlet weak var ocrLabel: UILabel!
    @IBOutlet weak var OCRMatchingBarcodeOrMrzLabel: UILabel!
